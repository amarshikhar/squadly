 ...
 *
 * Eager init is safe here: `new Razorpay({key_id: '', key_secret: ''})` does
 * not throw — the SDK only fails when you make an actual API call without
 * valid keys. So this module imports cleanly even when keys aren't set in
 * the build env.
 */
