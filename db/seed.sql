...
INSERT INTO services (id, creator_id, type, game, title, description, price_inr, duration_min, status) VALUES
    ('s1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'coaching', 'bgmi', '1-Hour BGMI Coaching · Conqueror', 'Personal review of your gameplay + drills tailored to your weaknesses. We''ll fix your aim, rotation, and final-zone decisions.', 50000, 60, 'live'),
    ('s2222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'duo', 'bgmi', '5-Game Duo Push', 'Queue with me for 5 ranked matches. I''ll IGL and we''ll push points together.', 80000, 120, 'live'),
    ('s3333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', 'coaching', 'valorant', 'Radiant Coaching · Aim & Crosshair', '90-min deep dive into your aim mechanics, crosshair placement, and lineup understanding.', 75000, 90, 'live'),
    ('s4444444-4444-4444-4444-444444444444', '22222222-2222-2222-2222-222222222222', 'lineup', 'valorant', 'Custom Lineup Pack · Any Map', 'I''ll create a complete lineup pack (smokes, mollies, recalls) for the map of your choice. Delivered in 48h.', 35000, 48 * 60, 'live'),
    ('s5555555-5555-5555-5555-555555555555', '33333333-3333-3333-3333-333333333333', 'hype_reel', 'free_fire', 'Custom Hype Reel · 30s', 'Cinematic 30-second hype reel of YOUR gameplay clips. Edited to your music.', 25000, 24 * 60, 'live'),
    ('s6666666-6666-6666-6666-666666666666', '44444444-4444-4444-4444-444444444444', 'rank_push', 'bgmi', 'Rank Push to Crown', 'Boost your account from Diamond to Crown in 7 days. Hand-played, no scripts.', 200000, 7 * 24 * 60, 'live'),
    ('s7777777-7777-7777-7777-777777777777', '55555555-5555-5555-5555-555555555555', 'crosshair_fix', 'valorant', 'Crosshair Fix Session · 30min', 'Quick session to dial in your perfect crosshair placement. Includes settings file.', 15000, 30, 'live');
...
INSERT INTO squad_goals (id, creator_id, title, description, target_coins, current_coins, contributors_count, status, deadline) VALUES
    ('g1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'Conqueror push tonight — full lobby, no leave', 'If we hit 1500 coins by 10pm IST, I go for back-to-back chickens until Conqueror.', 1500, 1250, 47, 'active', now() + interval '2 hours 14 minutes'),
    ('g2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'Surrender-free Saturday: 10 wins streak', 'Push to win 10 ranked games in a row — if I lose any, I refund all coins.', 3000, 1840, 23, 'active', now() + interval '5 hours'),
    ('g3333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'Free Fire Heroic dash · 2 hour grind', 'Two-hour push session if we hit goal.', 800, 800, 18, 'funded', now() - interval '1 hour');
...
INSERT INTO lobby_passes (id, creator_id, title, description, game, slot_count, min_bid_coins, ends_at, session_at, session_duration_min, starts_at) VALUES
    ('p1111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'Pro Squad Night — full party play', '4-hour squad with me + my pro stack. Tonight 9pm IST.', 'valorant', 3, 200, now() + interval '42 minutes', now() + interval '6 hours', 240, now() - interval '4 hours'),
    ('p2222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'BGMI Conqueror Lobby', '2-hour duo session at Conqueror lobby this Friday.', 'bgmi', 2, 300, now() + interval '1 day', now() + interval '3 days', 120, now());

-- Lobby Pass Bids -------------------------------------------------------------
INSERT INTO lobby_pass_bids (pass_id, bidder_id, coin_amount, status) VALUES
    ('p1111111-1111-1111-1111-111111111111', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 850, 'winning'),
    ('p1111111-1111-1111-1111-111111111111', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 820, 'outbid'),
    ('p1111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 750, 'outbid'),
    ('p1111111-1111-1111-1111-111111111111', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 700, 'outbid'),
    ('p1111111-1111-1111-1111-111111111111', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 600, 'outbid');
...
INSERT INTO service_requests (id, service_id, creator_id, buyer_id, status, price_inr_paid, platform_fee_inr, creator_payout_inr, completed_at) VALUES
    ('r1111111-1111-1111-1111-111111111111', 's1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'completed', 50000, 7500, 42500, now() - interval '3 days'),
    ('r2222222-2222-2222-2222-222222222222', 's3333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'completed', 75000, 11250, 63750, now() - interval '7 days');

INSERT INTO reviews (request_id, creator_id, reviewer_id, rating, body) VALUES
    ('r1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 5, 'Insane session. Fixed my crosshair placement in 20 minutes. Pushed Crown the same week.'),
    ('r2222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 5, 'Best Valorant coach I''ve worked with. Worth every rupee.');
